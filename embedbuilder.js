...
exports.fetchedmatchdetails = (json)=>{
  ...
  const matchDetails = new Discord.MessageEmbed({
    ...
    author: {
      ...
      iconURL: `${Utils.logoBaseUrl}${Utils.getBattingBowlingTeam(json).battingTeam["logoUrl"]}`
      
    },
    fields: fields,
     footer: {
      text:`🥎${Utils.getBattingBowlingTeam(json).bowlingTeam["displayName"]}`, 
      iconURL: `${Utils.logoBaseUrl}${Utils.getBattingBowlingTeam(json).bowlingTeam["logoUrl"]}`
    },
  });
